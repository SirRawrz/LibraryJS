...
if (Module["locateFile"]) {
 wasmBinaryFile = "mednafen_lynx_libretro.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("mednafen_lynx_libretro.wasm", import.meta.url).href;
}
...
var wasmImports = {
 ...
 /** @export */ Uh: _PlatformEmscriptenPowerStateGetCharging,
 /** @export */ Th: _PlatformEmscriptenPowerStateGetDischargeTime,
 /** @export */ Ia: _PlatformEmscriptenPowerStateGetLevel,
 /** @export */ Sh: _PlatformEmscriptenPowerStateGetSupported,
 /** @export */ Rh: _PlatformEmscriptenPowerStateInit,
 /** @export */ Qh: _RWebCamFree,
 /** @export */ Oa: _RWebCamInit,
 /** @export */ Ph: _RWebCamPoll,
 /** @export */ Oh: _RWebCamStart,
 /** @export */ Nh: _RWebCamStop,
 /** @export */ D: ___assert_fail,
 /** @export */ Ha: ___cxa_throw,
 /** @export */ Mh: ___syscall_accept4,
 /** @export */ Lh: ___syscall_bind,
 /** @export */ Kh: ___syscall_connect,
 /** @export */ k: ___syscall_fcntl64,
 /** @export */ Na: ___syscall_ftruncate64,
 /** @export */ Jh: ___syscall_getcwd,
 /** @export */ Ih: ___syscall_getdents64,
 /** @export */ Hh: ___syscall_getsockname,
 /** @export */ Gh: ___syscall_getsockopt,
 /** @export */ Fh: ___syscall_ioctl,
 /** @export */ Eh: ___syscall_listen,
 /** @export */ Dh: ___syscall_mkdirat,
 /** @export */ Ga: ___syscall_openat,
 /** @export */ Ch: ___syscall_poll,
 /** @export */ Bh: ___syscall_readlinkat,
 /** @export */ Ah: ___syscall_recvfrom,
 /** @export */ zh: ___syscall_renameat,
 /** @export */ yh: ___syscall_rmdir,
 /** @export */ xh: ___syscall_sendto,
 /** @export */ Fa: ___syscall_socket,
 /** @export */ wh: ___syscall_stat64,
 /** @export */ vh: ___syscall_unlinkat,
 /** @export */ sh: __emscripten_get_now_is_monotonic,
 /** @export */ rh: __emscripten_throw_longjmp,
 /** @export */ La: __localtime_js,
 /** @export */ Ka: __mktime_js,
 /** @export */ qh: __tzset_js,
 /** @export */ o: _abort,
 /** @export */ ph: _alBufferData,
 /** @export */ oh: _alDeleteBuffers,
 /** @export */ nh: _alDeleteSources,
 /** @export */ mh: _alGenBuffers,
 /** @export */ lh: _alGenSources,
 /** @export */ Da: _alGetError,
 /** @export */ Q: _alGetSourcei,
 /** @export */ kh: _alSourcePlay,
 /** @export */ jh: _alSourceQueueBuffers,
 /** @export */ ih: _alSourceStop,
 /** @export */ Ca: _alSourceUnqueueBuffers,
 /** @export */ hh: _alcCloseDevice,
 /** @export */ gh: _alcCreateContext,
 /** @export */ fh: _alcDestroyContext,
 /** @export */ Ba: _alcMakeContextCurrent,
 /** @export */ eh: _alcOpenDevice,
 /** @export */ dh: _eglBindAPI,
 /** @export */ ch: _eglChooseConfig,
 /** @export */ Aa: _eglCreateContext,
 /** @export */ bh: _eglCreateWindowSurface,
 /** @export */ za: _eglDestroyContext,
 /** @export */ ah: _eglDestroySurface,
 /** @export */ $g: _eglGetConfigs,
 /** @export */ _g: _eglGetCurrentContext,
 /** @export */ Zg: _eglGetDisplay,
 /** @export */ Yg: _eglGetError,
 /** @export */ Xg: _eglInitialize,
 /** @export */ Z: _eglMakeCurrent,
 /** @export */ ya: _eglQuerySurface,
 /** @export */ Wg: _eglSwapBuffers,
 /** @export */ Vg: _eglTerminate,
 /** @export */ Ug: _emscripten_asm_const_async_on_main_thread,
 /** @export */ xa: _emscripten_asm_const_int_sync_on_main_thread,
 /** @export */ Tg: _emscripten_async_wget2_data,
 /** @export */ Sg: _emscripten_cancel_main_loop,
 /** @export */ Rg: _emscripten_date_now,
 /** @export */ Qg: _emscripten_exit_pointerlock,
 /** @export */ Pg: _emscripten_force_exit,
 /** @export */ wa: _emscripten_get_canvas_element_size,
 /** @export */ Y: _emscripten_get_device_pixel_ratio,
 /** @export */ va: _emscripten_get_element_css_size,
 /** @export */ ua: _emscripten_get_fullscreen_status,
 /** @export */ f: _emscripten_get_gamepad_status,
 /** @export */ Og: _emscripten_get_heap_max,
 /** @export */ Ng: _emscripten_get_now,
 /** @export */ Mg: _emscripten_glActiveTexture,
 /** @export */ Lg: _emscripten_glAttachShader,
 /** @export */ Kg: _emscripten_glBeginQuery,
 /** @export */ Jg: _emscripten_glBeginQueryEXT,
 /** @export */ Ig: _emscripten_glBeginTransformFeedback,
 /** @export */ Hg: _emscripten_glBindAttribLocation,
 /** @export */ Gg: _emscripten_glBindBuffer,
 /** @export */ Fg: _emscripten_glBindBufferBase,
 /** @export */ Eg: _emscripten_glBindBufferRange,
 /** @export */ Dg: _emscripten_glBindFramebuffer,
 /** @export */ Cg: _emscripten_glBindRenderbuffer,
 /** @export */ Bg: _emscripten_glBindSampler,
 /** @export */ Ag: _emscripten_glBindTexture,
 /** @export */ zg: _emscripten_glBindTransformFeedback,
 /** @export */ yg: _emscripten_glBindVertexArray,
 /** @export */ xg: _emscripten_glBindVertexArrayOES,
 /** @export */ wg: _emscripten_glBlendColor,
 /** @export */ vg: _emscripten_glBlendEquation,
 /** @export */ ug: _emscripten_glBlendEquationSeparate,
 /** @export */ tg: _emscripten_glBlendFunc,
 /** @export */ sg: _emscripten_glBlendFuncSeparate,
 /** @export */ rg: _emscripten_glBlitFramebuffer,
 /** @export */ qg: _emscripten_glBufferData,
 /** @export */ pg: _emscripten_glBufferSubData,
 /** @export */ og: _emscripten_glCheckFramebufferStatus,
 /** @export */ ng: _emscripten_glClear,
 /** @export */ mg: _emscripten_glClearBufferfi,
 /** @export */ lg: _emscripten_glClearBufferfv,
 /** @export */ kg: _emscripten_glClearBufferiv,
 /** @export */ jg: _emscripten_glClearBufferuiv,
 /** @export */ ig: _emscripten_glClearColor,
 /** @export */ hg: _emscripten_glClearDepthf,
 /** @export */ gg: _emscripten_glClearStencil,
 /** @export */ fg: _emscripten_glClientWaitSync,
 /** @export */ eg: _emscripten_glColorMask,
 /** @export */ dg: _emscripten_glCompileShader,
 /** @export */ cg: _emscripten_glCompressedTexImage2D,
 /** @export */ bg: _emscripten_glCompressedTexImage3D,
 /** @export */ ag: _emscripten_glCompressedTexSubImage2D,
 /** @export */ $f: _emscripten_glCompressedTexSubImage3D,
 /** @export */ _f: _emscripten_glCopyBufferSubData,
 /** @export */ Zf: _emscripten_glCopyTexImage2D,
 /** @export */ Yf: _emscripten_glCopyTexSubImage2D,
 /** @export */ Xf: _emscripten_glCopyTexSubImage3D,
 /** @export */ Wf: _emscripten_glCreateProgram,
 /** @export */ Vf: _emscripten_glCreateShader,
 /** @export */ Uf: _emscripten_glCullFace,
 /** @export */ Tf: _emscripten_glDeleteBuffers,
 /** @export */ Sf: _emscripten_glDeleteFramebuffers,
 /** @export */ Rf: _emscripten_glDeleteProgram,
 /** @export */ Qf: _emscripten_glDeleteQueries,
 /** @export */ Pf: _emscripten_glDeleteQueriesEXT,
 /** @export */ Of: _emscripten_glDeleteRenderbuffers,
 /** @export */ Nf: _emscripten_glDeleteSamplers,
 /** @export */ Mf: _emscripten_glDeleteShader,
 /** @export */ Lf: _emscripten_glDeleteSync,
 /** @export */ Kf: _emscripten_glDeleteTextures,
 /** @export */ Jf: _emscripten_glDeleteTransformFeedbacks,
 /** @export */ If: _emscripten_glDeleteVertexArrays,
 /** @export */ Hf: _emscripten_glDeleteVertexArraysOES,
 /** @export */ Gf: _emscripten_glDepthFunc,
 /** @export */ Ff: _emscripten_glDepthMask,
 /** @export */ Ef: _emscripten_glDepthRangef,
 /** @export */ Df: _emscripten_glDetachShader,
 /** @export */ Cf: _emscripten_glDisable,
 /** @export */ Bf: _emscripten_glDisableVertexAttribArray,
 /** @export */ Af: _emscripten_glDrawArrays,
 /** @export */ zf: _emscripten_glDrawArraysInstanced,
 /** @export */ yf: _emscripten_glDrawArraysInstancedANGLE,
 /** @export */ xf: _emscripten_glDrawArraysInstancedARB,
 /** @export */ wf: _emscripten_glDrawArraysInstancedEXT,
 /** @export */ vf: _emscripten_glDrawArraysInstancedNV,
 /** @export */ uf: _emscripten_glDrawBuffers,
 /** @export */ tf: _emscripten_glDrawBuffersEXT,
 /** @export */ sf: _emscripten_glDrawBuffersWEBGL,
 /** @export */ rf: _emscripten_glDrawElements,
 /** @export */ qf: _emscripten_glDrawElementsInstanced,
 /** @export */ pf: _emscripten_glDrawElementsInstancedANGLE,
 /** @export */ of: _emscripten_glDrawElementsInstancedARB,
 /** @export */ nf: _emscripten_glDrawElementsInstancedEXT,
 /** @export */ mf: _emscripten_glDrawElementsInstancedNV,
 /** @export */ lf: _emscripten_glDrawRangeElements,
 /** @export */ kf: _emscripten_glEnable,
 /** @export */ jf: _emscripten_glEnableVertexAttribArray,
 /** @export */ hf: _emscripten_glEndQuery,
 /** @export */ gf: _emscripten_glEndQueryEXT,
 /** @export */ ff: _emscripten_glEndTransformFeedback,
 /** @export */ ef: _emscripten_glFenceSync,
 /** @export */ df: _emscripten_glFinish,
 /** @export */ cf: _emscripten_glFlush,
 /** @export */ bf: _emscripten_glFramebufferRenderbuffer,
 /** @export */ af: _emscripten_glFramebufferTexture2D,
 /** @export */ $e: _emscripten_glFramebufferTextureLayer,
 /** @export */ _e: _emscripten_glFrontFace,
 /** @export */ Ze: _emscripten_glGenBuffers,
 /** @export */ Ye: _emscripten_glGenFramebuffers,
 /** @export */ Xe: _emscripten_glGenQueries,
 /** @export */ We: _emscripten_glGenQueriesEXT,
 /** @export */ Ve: _emscripten_glGenRenderbuffers,
 /** @export */ Ue: _emscripten_glGenSamplers,
 /** @export */ Te: _emscripten_glGenTextures,
 /** @export */ Se: _emscripten_glGenTransformFeedbacks,
 /** @export */ Re: _emscripten_glGenVertexArrays,
 /** @export */ Qe: _emscripten_glGenVertexArraysOES,
 /** @export */ Pe: _emscripten_glGenerateMipmap,
 /** @export */ Oe: _emscripten_glGetActiveAttrib,
 /** @export */ Ne: _emscripten_glGetActiveUniform,
 /** @export */ Me: _emscripten_glGetActiveUniformBlockName,
 /** @export */ Le: _emscripten_glGetActiveUniformBlockiv,
 /** @export */ Ke: _emscripten_glGetActiveUniformsiv,
 /** @export */ Je: _emscripten_glGetAttachedShaders,
 /** @export */ Ie: _emscripten_glGetAttribLocation,
 /** @export */ He: _emscripten_glGetBooleanv,
 /** @export */ Ge: _emscripten_glGetBufferParameteri64v,
 /** @export */ Fe: _emscripten_glGetBufferParameteriv,
 /** @export */ Ee: _emscripten_glGetError,
 /** @export */ De: _emscripten_glGetFloatv,
 /** @export */ Ce: _emscripten_glGetFragDataLocation,
 /** @export */ Be: _emscripten_glGetFramebufferAttachmentParameteriv,
 /** @export */ Ae: _emscripten_glGetInteger64i_v,
 /** @export */ ze: _emscripten_glGetInteger64v,
 /** @export */ ye: _emscripten_glGetIntegeri_v,
 /** @export */ xe: _emscripten_glGetIntegerv,
 /** @export */ we: _emscripten_glGetInternalformativ,
 /** @export */ ve: _emscripten_glGetProgramBinary,
 /** @export */ ue: _emscripten_glGetProgramInfoLog,
 /** @export */ te: _emscripten_glGetProgramiv,
 /** @export */ se: _emscripten_glGetQueryObjecti64vEXT,
 /** @export */ re: _emscripten_glGetQueryObjectivEXT,
 /** @export */ qe: _emscripten_glGetQueryObjectui64vEXT,
 /** @export */ pe: _emscripten_glGetQueryObjectuiv,
 /** @export */ oe: _emscripten_glGetQueryObjectuivEXT,
 /** @export */ ne: _emscripten_glGetQueryiv,
 /** @export */ me: _emscripten_glGetQueryivEXT,
 /** @export */ le: _emscripten_glGetRenderbufferParameteriv,
 /** @export */ ke: _emscripten_glGetSamplerParameterfv,
 /** @export */ je: _emscripten_glGetSamplerParameteriv,
 /** @export */ ie: _emscripten_glGetShaderInfoLog,
 /** @export */ he: _emscripten_glGetShaderPrecisionFormat,
 /** @export */ ge: _emscripten_glGetShaderSource,
 /** @export */ fe: _emscripten_glGetShaderiv,
 /** @export */ ee: _emscripten_glGetString,
 /** @export */ de: _emscripten_glGetStringi,
 /** @export */ ce: _emscripten_glGetSynciv,
 /** @export */ be: _emscripten_glGetTexParameterfv,
 /** @export */ ae: _emscripten_glGetTexParameteriv,
 /** @export */ $d: _emscripten_glGetTransformFeedbackVarying,
 /** @export */ _d: _emscripten_glGetUniformBlockIndex,
 /** @export */ Zd: _emscripten_glGetUniformIndices,
 /** @export */ Yd: _emscripten_glGetUniformLocation,
 /** @export */ Xd: _emscripten_glGetUniformfv,
 /** @export */ Wd: _emscripten_glGetUniformiv,
 /** @export */ Vd: _emscripten_glGetUniformuiv,
 /** @export */ Ud: _emscripten_glGetVertexAttribIiv,
 /** @export */ Td: _emscripten_glGetVertexAttribIuiv,
 /** @export */ Sd: _emscripten_glGetVertexAttribPointerv,
 /** @export */ Rd: _emscripten_glGetVertexAttribfv,
 /** @export */ Qd: _emscripten_glGetVertexAttribiv,
 /** @export */ Pd: _emscripten_glHint,
 /** @export */ Od: _emscripten_glInvalidateFramebuffer,
 /** @export */ Nd: _emscripten_glInvalidateSubFramebuffer,
 /** @export */ Md: _emscripten_glIsBuffer,
 /** @export */ Ld: _emscripten_glIsEnabled,
 /** @export */ Kd: _emscripten_glIsFramebuffer,
 /** @export */ Jd: _emscripten_glIsProgram,
 /** @export */ Id: _emscripten_glIsQuery,
 /** @export */ Hd: _emscripten_glIsQueryEXT,
 /** @export */ Gd: _emscripten_glIsRenderbuffer,
 /** @export */ Fd: _emscripten_glIsSampler,
 /** @export */ Ed: _emscripten_glIsShader,
 /** @export */ Dd: _emscripten_glIsSync,
 /** @export */ Cd: _emscripten_glIsTexture,
 /** @export */ Bd: _emscripten_glIsTransformFeedback,
 /** @export */ Ad: _emscripten_glIsVertexArray,
 /** @export */ zd: _emscripten_glIsVertexArrayOES,
 /** @export */ yd: _emscripten_glLineWidth,
 /** @export */ xd: _emscripten_glLinkProgram,
 /** @export */ wd: _emscripten_glPauseTransformFeedback,
 /** @export */ vd: _emscripten_glPixelStorei,
 /** @export */ ud: _emscripten_glPolygonOffset,
 /** @export */ td: _emscripten_glProgramBinary,
 /** @export */ sd: _emscripten_glProgramParameteri,
 /** @export */ rd: _emscripten_glQueryCounterEXT,
 /** @export */ qd: _emscripten_glReadBuffer,
 /** @export */ pd: _emscripten_glReadPixels,
 /** @export */ od: _emscripten_glReleaseShaderCompiler,
 /** @export */ nd: _emscripten_glRenderbufferStorage,
 /** @export */ md: _emscripten_glRenderbufferStorageMultisample,
 /** @export */ ld: _emscripten_glResumeTransformFeedback,
 /** @export */ kd: _emscripten_glSampleCoverage,
 /** @export */ jd: _emscripten_glSamplerParameterf,
 /** @export */ id: _emscripten_glSamplerParameterfv,
 /** @export */ hd: _emscripten_glSamplerParameteri,
 /** @export */ gd: _emscripten_glSamplerParameteriv,
 /** @export */ fd: _emscripten_glScissor,
 /** @export */ ed: _emscripten_glShaderBinary,
 /** @export */ dd: _emscripten_glShaderSource,
 /** @export */ cd: _emscripten_glStencilFunc,
 /** @export */ bd: _emscripten_glStencilFuncSeparate,
 /** @export */ ad: _emscripten_glStencilMask,
 /** @export */ $c: _emscripten_glStencilMaskSeparate,
 /** @export */ _c: _emscripten_glStencilOp,
 /** @export */ Zc: _emscripten_glStencilOpSeparate,
 /** @export */ Yc: _emscripten_glTexImage2D,
 /** @export */ Xc: _emscripten_glTexImage3D,
 /** @export */ Wc: _emscripten_glTexParameterf,
 /** @export */ Vc: _emscripten_glTexParameterfv,
 /** @export */ Uc: _emscripten_glTexParameteri,
 /** @export */ Tc: _emscripten_glTexParameteriv,
 /** @export */ Sc: _emscripten_glTexStorage2D,
 /** @export */ Rc: _emscripten_glTexStorage3D,
 /** @export */ Qc: _emscripten_glTexSubImage2D,
 /** @export */ Pc: _emscripten_glTexSubImage3D,
 /** @export */ Oc: _emscripten_glTransformFeedbackVaryings,
 /** @export */ Nc: _emscripten_glUniform1f,
 /** @export */ Mc: _emscripten_glUniform1fv,
 /** @export */ Lc: _emscripten_glUniform1i,
 /** @export */ Kc: _emscripten_glUniform1iv,
 /** @export */ Jc: _emscripten_glUniform1ui,
 /** @export */ Ic: _emscripten_glUniform1uiv,
 /** @export */ Hc: _emscripten_glUniform2f,
 /** @export */ Gc: _emscripten_glUniform2fv,
 /** @export */ Fc: _emscripten_glUniform2i,
 /** @export */ Ec: _emscripten_glUniform2iv,
 /** @export */ Dc: _emscripten_glUniform2ui,
 /** @export */ Cc: _emscripten_glUniform2uiv,
 /** @export */ Bc: _emscripten_glUniform3f,
 /** @export */ Ac: _emscripten_glUniform3fv,
 /** @export */ zc: _emscripten_glUniform3i,
 /** @export */ yc: _emscripten_glUniform3iv,
 /** @export */ xc: _emscripten_glUniform3ui,
 /** @export */ wc: _emscripten_glUniform3uiv,
 /** @export */ vc: _emscripten_glUniform4f,
 /** @export */ uc: _emscripten_glUniform4fv,
 /** @export */ tc: _emscripten_glUniform4i,
 /** @export */ sc: _emscripten_glUniform4iv,
 /** @export */ rc: _emscripten_glUniform4ui,
 /** @export */ qc: _emscripten_glUniform4uiv,
 /** @export */ pc: _emscripten_glUniformBlockBinding,
 /** @export */ oc: _emscripten_glUniformMatrix2fv,
 /** @export */ nc: _emscripten_glUniformMatrix2x3fv,
 /** @export */ mc: _emscripten_glUniformMatrix2x4fv,
 /** @export */ lc: _emscripten_glUniformMatrix3fv,
 /** @export */ kc: _emscripten_glUniformMatrix3x2fv,
 /** @export */ jc: _emscripten_glUniformMatrix3x4fv,
 /** @export */ ic: _emscripten_glUniformMatrix4fv,
 /** @export */ hc: _emscripten_glUniformMatrix4x2fv,
 /** @export */ gc: _emscripten_glUniformMatrix4x3fv,
 ...
 /** @export */ $b: _emscripten_glVertexAttrib3f,
 /** @export */ _b: _emscripten_glVertexAttrib3fv,
 /** @export */ Zb: _emscripten_glVertexAttrib4f,
 /** @export */ Yb: _emscripten_glVertexAttrib4fv,
 /** @export */ Xb: _emscripten_glVertexAttribDivisor,
 /** @export */ Wb: _emscripten_glVertexAttribDivisorANGLE,
 /** @export */ Vb: _emscripten_glVertexAttribDivisorARB,
 /** @export */ Ub: _emscripten_glVertexAttribDivisorEXT,
 /** @export */ Tb: _emscripten_glVertexAttribDivisorNV,
 /** @export */ Sb: _emscripten_glVertexAttribI4i,
 /** @export */ Rb: _emscripten_glVertexAttribI4iv,
 /** @export */ Qb: _emscripten_glVertexAttribI4ui,
 /** @export */ Pb: _emscripten_glVertexAttribI4uiv,
 /** @export */ Ob: _emscripten_glVertexAttribIPointer,
 /** @export */ Nb: _emscripten_glVertexAttribPointer,
 /** @export */ Mb: _emscripten_glViewport,
 /** @export */ Lb: _emscripten_glWaitSync,
 /** @export */ Kb: _emscripten_html5_remove_all_event_listeners,
 /** @export */ Jb: _emscripten_memcpy_js,
 /** @export */ Ib: _emscripten_request_pointerlock,
 /** @export */ Hb: _emscripten_resize_heap,
 /** @export */ ta: _emscripten_sample_gamepad_data,
 /** @export */ X: _emscripten_set_canvas_element_size,
 /** @export */ Gb: _emscripten_set_element_css_size,
 ...
 /** @export */ zb: _emscripten_set_main_loop_arg,
 /** @export */ P: _emscripten_set_main_loop_timing,
 /** @export */ yb: _emscripten_set_mousedown_callback_on_thread,
 /** @export */ xb: _emscripten_set_mousemove_callback_on_thread,
 /** @export */ wb: _emscripten_set_mouseup_callback_on_thread,
 /** @export */ vb: _emscripten_set_pointerlockchange_callback_on_thread,
 /** @export */ ub: _emscripten_set_touchcancel_callback_on_thread,
 /** @export */ tb: _emscripten_set_touchend_callback_on_thread,
 /** @export */ sb: _emscripten_set_touchmove_callback_on_thread,
 /** @export */ rb: _emscripten_set_touchstart_callback_on_thread,
 /** @export */ qb: _emscripten_set_wheel_callback_on_thread,
 /** @export */ O: _emscripten_sleep,
 /** @export */ pb: _emscripten_webgl_create_context,
 /** @export */ sa: _emscripten_webgl_destroy_context,
 /** @export */ ob: _emscripten_webgl_get_drawing_buffer_size,
 /** @export */ nb: _emscripten_webgl_init_context_attributes,
 /** @export */ ra: _emscripten_webgl_make_context_current,
 /** @export */ uh: _environ_get,
 /** @export */ th: _environ_sizes_get,
 /** @export */ mb: _exit,
 /** @export */ K: _fd_close,
 /** @export */ Ea: _fd_read,
 /** @export */ Ma: _fd_seek,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["Wh"])();

var _free = Module["_free"] = a0 => (_free = Module["_free"] = wasmExports["Yh"])(a0);

var _malloc = Module["_malloc"] = a0 => (_malloc = Module["_malloc"] = wasmExports["Zh"])(a0);

var setTempRet0 = a0 => (setTempRet0 = wasmExports["_h"])(a0);

var ___errno_location = () => (___errno_location = wasmExports["$h"])();

var _PlatformEmscriptenCommandRaiseFlag = () => (_PlatformEmscriptenCommandRaiseFlag = wasmExports["ai"])();

var _cmd_savefiles = Module["_cmd_savefiles"] = () => (_cmd_savefiles = Module["_cmd_savefiles"] = wasmExports["bi"])();

var _cmd_save_state = Module["_cmd_save_state"] = () => (_cmd_save_state = Module["_cmd_save_state"] = wasmExports["ci"])();

var _cmd_load_state = Module["_cmd_load_state"] = () => (_cmd_load_state = Module["_cmd_load_state"] = wasmExports["di"])();

var _cmd_undo_save_state = Module["_cmd_undo_save_state"] = () => (_cmd_undo_save_state = Module["_cmd_undo_save_state"] = wasmExports["ei"])();

var _cmd_undo_load_state = Module["_cmd_undo_load_state"] = () => (_cmd_undo_load_state = Module["_cmd_undo_load_state"] = wasmExports["fi"])();

var _cmd_take_screenshot = Module["_cmd_take_screenshot"] = () => (_cmd_take_screenshot = Module["_cmd_take_screenshot"] = wasmExports["gi"])();

var _cmd_toggle_menu = Module["_cmd_toggle_menu"] = () => (_cmd_toggle_menu = Module["_cmd_toggle_menu"] = wasmExports["hi"])();

var _cmd_reload_config = Module["_cmd_reload_config"] = () => (_cmd_reload_config = Module["_cmd_reload_config"] = wasmExports["ii"])();

var _cmd_toggle_grab_mouse = Module["_cmd_toggle_grab_mouse"] = () => (_cmd_toggle_grab_mouse = Module["_cmd_toggle_grab_mouse"] = wasmExports["ji"])();

var _cmd_toggle_game_focus = Module["_cmd_toggle_game_focus"] = () => (_cmd_toggle_game_focus = Module["_cmd_toggle_game_focus"] = wasmExports["ki"])();

var _cmd_reset = Module["_cmd_reset"] = () => (_cmd_reset = Module["_cmd_reset"] = wasmExports["li"])();

var _cmd_toggle_pause = Module["_cmd_toggle_pause"] = () => (_cmd_toggle_pause = Module["_cmd_toggle_pause"] = wasmExports["mi"])();

var _cmd_pause = Module["_cmd_pause"] = () => (_cmd_pause = Module["_cmd_pause"] = wasmExports["ni"])();

var _cmd_unpause = Module["_cmd_unpause"] = () => (_cmd_unpause = Module["_cmd_unpause"] = wasmExports["oi"])();

var _cmd_set_volume = Module["_cmd_set_volume"] = a0 => (_cmd_set_volume = Module["_cmd_set_volume"] = wasmExports["pi"])(a0);

var _cmd_set_shader = Module["_cmd_set_shader"] = a0 => (_cmd_set_shader = Module["_cmd_set_shader"] = wasmExports["qi"])(a0);

var _cmd_cheat_set_code = Module["_cmd_cheat_set_code"] = (a0, a1) => (_cmd_cheat_set_code = Module["_cmd_cheat_set_code"] = wasmExports["ri"])(a0, a1);

var _cmd_cheat_get_code = Module["_cmd_cheat_get_code"] = a0 => (_cmd_cheat_get_code = Module["_cmd_cheat_get_code"] = wasmExports["si"])(a0);

var _cmd_cheat_toggle_index = Module["_cmd_cheat_toggle_index"] = (a0, a1) => (_cmd_cheat_toggle_index = Module["_cmd_cheat_toggle_index"] = wasmExports["ti"])(a0, a1);

var _cmd_cheat_get_code_state = Module["_cmd_cheat_get_code_state"] = a0 => (_cmd_cheat_get_code_state = Module["_cmd_cheat_get_code_state"] = wasmExports["ui"])(a0);

var _cmd_cheat_realloc = Module["_cmd_cheat_realloc"] = a0 => (_cmd_cheat_realloc = Module["_cmd_cheat_realloc"] = wasmExports["vi"])(a0);

var _cmd_cheat_get_size = Module["_cmd_cheat_get_size"] = () => (_cmd_cheat_get_size = Module["_cmd_cheat_get_size"] = wasmExports["wi"])();

var _cmd_cheat_apply_cheats = Module["_cmd_cheat_apply_cheats"] = () => (_cmd_cheat_apply_cheats = Module["_cmd_cheat_apply_cheats"] = wasmExports["xi"])();

var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["yi"])(a0, a1);

var _htons = a0 => (_htons = wasmExports["zi"])(a0);

var _ntohs = a0 => (_ntohs = wasmExports["Ai"])(a0);

var _htonl = a0 => (_htonl = wasmExports["Bi"])(a0);

var _setThrew = (a0, a1) => (_setThrew = wasmExports["Ci"])(a0, a1);

var stackSave = () => (stackSave = wasmExports["Di"])();

var stackRestore = a0 => (stackRestore = wasmExports["Ei"])(a0);

var stackAlloc = a0 => (stackAlloc = wasmExports["Fi"])(a0);

var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["Gi"])(a0);

var dynCall_v = Module["dynCall_v"] = a0 => (dynCall_v = Module["dynCall_v"] = wasmExports["Hi"])(a0);

var dynCall_viiii = Module["dynCall_viiii"] = (a0, a1, a2, a3, a4) => (dynCall_viiii = Module["dynCall_viiii"] = wasmExports["Ii"])(a0, a1, a2, a3, a4);

var dynCall_i = Module["dynCall_i"] = a0 => (dynCall_i = Module["dynCall_i"] = wasmExports["Ji"])(a0);

var dynCall_ii = Module["dynCall_ii"] = (a0, a1) => (dynCall_ii = Module["dynCall_ii"] = wasmExports["Ki"])(a0, a1);

var dynCall_vii = Module["dynCall_vii"] = (a0, a1, a2) => (dynCall_vii = Module["dynCall_vii"] = wasmExports["Li"])(a0, a1, a2);

var dynCall_iiii = Module["dynCall_iiii"] = (a0, a1, a2, a3) => (dynCall_iiii = Module["dynCall_iiii"] = wasmExports["Mi"])(a0, a1, a2, a3);

var dynCall_iiiiii = Module["dynCall_iiiiii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiii = Module["dynCall_iiiiii"] = wasmExports["Ni"])(a0, a1, a2, a3, a4, a5);

var dynCall_vi = Module["dynCall_vi"] = (a0, a1) => (dynCall_vi = Module["dynCall_vi"] = wasmExports["Oi"])(a0, a1);

var dynCall_viii = Module["dynCall_viii"] = (a0, a1, a2, a3) => (dynCall_viii = Module["dynCall_viii"] = wasmExports["Pi"])(a0, a1, a2, a3);

var dynCall_iiiii = Module["dynCall_iiiii"] = (a0, a1, a2, a3, a4) => (dynCall_iiiii = Module["dynCall_iiiii"] = wasmExports["Qi"])(a0, a1, a2, a3, a4);

var dynCall_iii = Module["dynCall_iii"] = (a0, a1, a2) => (dynCall_iii = Module["dynCall_iii"] = wasmExports["Ri"])(a0, a1, a2);

var dynCall_iiiiiii = Module["dynCall_iiiiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiiii = Module["dynCall_iiiiiii"] = wasmExports["Si"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_j = Module["dynCall_j"] = a0 => (dynCall_j = Module["dynCall_j"] = wasmExports["Ti"])(a0);

var _asyncify_start_unwind = a0 => (_asyncify_start_unwind = wasmExports["Ui"])(a0);

var _asyncify_stop_unwind = () => (_asyncify_stop_unwind = wasmExports["Vi"])();

var _asyncify_start_rewind = a0 => (_asyncify_start_rewind = wasmExports["Wi"])(a0);

var _asyncify_stop_rewind = () => (_asyncify_stop_rewind = wasmExports["Xi"])();
...
export default libretro_mednafen_lynx;