...
if (ENVIRONMENT_IS_NODE) {
    ...
    // Running in browser: Replace Node.js file access with AJAX requests
    read_ = (url, binary) => {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", url, false);
        if (binary) xhr.responseType = "arraybuffer";
        xhr.send(null);
        return binary ? new Uint8Array(xhr.response) : xhr.responseText;
    };

    readBinary = url => read_(url, true);
}
...
if (typeof document !== "undefined" && document.currentScript) {
    wasmBinaryFile = new URL("pcsx_rearmed_libretro.wasm", document.currentScript.src).href;
} else {
    wasmBinaryFile = "pcsx_rearmed_libretro.wasm"; // Fallback for unknown cases
}
...
function createWasm() {
 ...
 /** @param {WebAssembly.Module=} module*/ function receiveInstance(instance, module) {
  ...
  wasmMemory = wasmExports["Xh"];
  updateMemoryViews();
  wasmTable = wasmExports["Zh"];
  addOnInit(wasmExports["Yh"]);
...
var RPE = {
 ...
 powerStateChange: function(e) {
  RPE.powerState.dischargeTime = Number.isFinite(e.target.dischargingTime) ? e.target.dischargingTime : 2147483647;
...
function _PlatformEmscriptenGetFreeMem() {
 if (!performance.memory) return 0;
 return (performance.memory.jsHeapSizeLimit || 0) - (performance.memory.usedJSHeapSize || 0);
}

function _PlatformEmscriptenGetTotalMem() {
 if (!performance.memory) return 0;
 return performance.memory.jsHeapSizeLimit || 0;
}

function _PlatformEmscriptenPowerStateGetCharging() {
 return RPE.powerState.charging;
}

function _PlatformEmscriptenPowerStateGetDischargeTime() {
 return RPE.powerState.dischargeTime;
}

function _PlatformEmscriptenPowerStateGetLevel() {
 return RPE.powerState.level;
}

function _PlatformEmscriptenPowerStateGetSupported() {
...
function _RWebCamPoll(data, frame_raw_cb, frame_gl_cb) {
 ...
 if (RWC.contexts[data].glTexId !== 0 && frame_gl_cb !== 0) {
  _glGetIntegerv(32873, /* GL_TEXTURE_BINDING_2D */ RWC.tmp);
  var prev = HEAP32[((RWC.tmp) >> 2)];
  _glBindTexture(3553, /* GL_TEXTURE_2D */ RWC.contexts[data].glTexId);
  ...
  _glBindTexture(3553, /* GL_TEXTURE_2D */ prev);
  Runtime.dynCall("viii", frame_gl_cb, [ RWC.contexts[data].glTexId, 3553, /* GL_TEXTURE_2D */ 0 ]);
  ret = 1;
 }
...
function _RWebCamStart(data) {
 ...
 if (RWC.contexts[data].glTex) {
  ...
  if (RWC.contexts[data].glTexId !== 0) {
   ...
   var prev = HEAP32[((RWC.tmp) >> 2)];
   _glBindTexture(3553, /* GL_TEXTURE_2D */ RWC.contexts[data].glTexId);
   /* NPOT textures in WebGL must have these filters and clamping settings */ _glTexParameteri(3553, /* GL_TEXTURE_2D */ 10240, /* GL_TEXTURE_MAG_FILTER */ 9729);
   /* GL_LINEAR */ _glTexParameteri(3553, /* GL_TEXTURE_2D */ 10241, /* GL_TEXTURE_MIN_FILTER */ 9729);
   /* GL_LINEAR */ _glTexParameteri(3553, /* GL_TEXTURE_2D */ 10242, /* GL_TEXTURE_WRAP_S */ 33071);
   /* GL_CLAMP_TO_EDGE */ _glTexParameteri(3553, /* GL_TEXTURE_2D */ 10243, /*GL_TEXTURE_WRAP_T */ 33071);
   /* GL_CLAMP_TO_EDGE */ _glBindTexture(3553, /* GL_TEXTURE_2D */ prev);
...
/* Magic ID for Emscripten 'default surface' */ var _eglGetConfigs = (display, configs, config_size, numConfigs) => EGL.chooseConfig(display, 0, configs, config_size, numConfigs);
...
/* EGL_FALSE */ var _eglTerminate = display => {
 if (display != 62e3) /* Magic ID for Emscripten 'default display' */ {
  EGL.setErrorCode(12296);
  /* EGL_BAD_DISPLAY */ return 0;
 }
...
var _emscripten_asm_const_async_on_main_thread = (code, sigPtr, argbuf) => runMainThreadEmAsm(code, sigPtr, argbuf, 0);
...
var wasmImports = {
 /** @export */ Qa: _PlatformEmscriptenGetFreeMem,
 /** @export */ Pa: _PlatformEmscriptenGetTotalMem,
 /** @export */ Wh: _PlatformEmscriptenPowerStateGetCharging,
 /** @export */ Vh: _PlatformEmscriptenPowerStateGetDischargeTime,
 /** @export */ Ia: _PlatformEmscriptenPowerStateGetLevel,
 /** @export */ Uh: _PlatformEmscriptenPowerStateGetSupported,
 /** @export */ Th: _PlatformEmscriptenPowerStateInit,
 /** @export */ Sh: _RWebCamFree,
 /** @export */ Oa: _RWebCamInit,
 /** @export */ Rh: _RWebCamPoll,
 /** @export */ Qh: _RWebCamStart,
 /** @export */ Ph: _RWebCamStop,
 /** @export */ D: ___assert_fail,
 /** @export */ Oh: ___syscall_accept4,
 /** @export */ Nh: ___syscall_bind,
 /** @export */ Mh: ___syscall_connect,
 /** @export */ k: ___syscall_fcntl64,
 /** @export */ Lh: ___syscall_fstat64,
 /** @export */ Na: ___syscall_ftruncate64,
 /** @export */ Kh: ___syscall_getcwd,
 /** @export */ Jh: ___syscall_getdents64,
 /** @export */ Ih: ___syscall_getsockname,
 /** @export */ Hh: ___syscall_getsockopt,
 /** @export */ Gh: ___syscall_ioctl,
 /** @export */ Fh: ___syscall_listen,
 /** @export */ Eh: ___syscall_lstat64,
 /** @export */ Dh: ___syscall_mkdirat,
 /** @export */ Ch: ___syscall_newfstatat,
 /** @export */ Ha: ___syscall_openat,
 /** @export */ Bh: ___syscall_poll,
 /** @export */ Ah: ___syscall_readlinkat,
 /** @export */ zh: ___syscall_recvfrom,
 /** @export */ yh: ___syscall_renameat,
 /** @export */ xh: ___syscall_rmdir,
 /** @export */ wh: ___syscall_sendto,
 /** @export */ Ga: ___syscall_socket,
 /** @export */ vh: ___syscall_stat64,
 /** @export */ uh: ___syscall_unlinkat,
 /** @export */ rh: __emscripten_get_now_is_monotonic,
 /** @export */ qh: __emscripten_throw_longjmp,
 /** @export */ La: __localtime_js,
 /** @export */ Ka: __mktime_js,
 /** @export */ ph: __tzset_js,
 /** @export */ o: _abort,
 /** @export */ oh: _alBufferData,
 /** @export */ nh: _alDeleteBuffers,
 /** @export */ mh: _alDeleteSources,
 /** @export */ lh: _alGenBuffers,
 /** @export */ kh: _alGenSources,
 /** @export */ Ea: _alGetError,
 /** @export */ Q: _alGetSourcei,
 /** @export */ jh: _alSourcePlay,
 /** @export */ ih: _alSourceQueueBuffers,
 /** @export */ hh: _alSourceStop,
 /** @export */ Da: _alSourceUnqueueBuffers,
 /** @export */ gh: _alcCloseDevice,
 /** @export */ fh: _alcCreateContext,
 /** @export */ eh: _alcDestroyContext,
 /** @export */ Ca: _alcMakeContextCurrent,
 /** @export */ dh: _alcOpenDevice,
 /** @export */ ch: _eglBindAPI,
 /** @export */ bh: _eglChooseConfig,
 /** @export */ Ba: _eglCreateContext,
 /** @export */ ah: _eglCreateWindowSurface,
 /** @export */ Aa: _eglDestroyContext,
 /** @export */ $g: _eglDestroySurface,
 /** @export */ _g: _eglGetConfigs,
 /** @export */ Zg: _eglGetCurrentContext,
 /** @export */ Yg: _eglGetDisplay,
 /** @export */ Xg: _eglGetError,
 /** @export */ Wg: _eglInitialize,
 /** @export */ Z: _eglMakeCurrent,
 /** @export */ za: _eglQuerySurface,
 /** @export */ Vg: _eglSwapBuffers,
 /** @export */ Ug: _eglTerminate,
 /** @export */ Tg: _emscripten_asm_const_async_on_main_thread,
 /** @export */ ya: _emscripten_asm_const_int_sync_on_main_thread,
 /** @export */ Sg: _emscripten_async_wget2_data,
 /** @export */ Rg: _emscripten_cancel_main_loop,
 /** @export */ Qg: _emscripten_date_now,
 /** @export */ Pg: _emscripten_exit_pointerlock,
 /** @export */ Og: _emscripten_force_exit,
 /** @export */ xa: _emscripten_get_canvas_element_size,
 /** @export */ Y: _emscripten_get_device_pixel_ratio,
 /** @export */ wa: _emscripten_get_element_css_size,
 /** @export */ va: _emscripten_get_fullscreen_status,
 /** @export */ f: _emscripten_get_gamepad_status,
 /** @export */ Ng: _emscripten_get_heap_max,
 /** @export */ Mg: _emscripten_get_now,
 /** @export */ Lg: _emscripten_glActiveTexture,
 /** @export */ Kg: _emscripten_glAttachShader,
 /** @export */ Jg: _emscripten_glBeginQuery,
 /** @export */ Ig: _emscripten_glBeginQueryEXT,
 /** @export */ Hg: _emscripten_glBeginTransformFeedback,
 /** @export */ Gg: _emscripten_glBindAttribLocation,
 /** @export */ Fg: _emscripten_glBindBuffer,
 /** @export */ Eg: _emscripten_glBindBufferBase,
 /** @export */ Dg: _emscripten_glBindBufferRange,
 /** @export */ Cg: _emscripten_glBindFramebuffer,
 /** @export */ Bg: _emscripten_glBindRenderbuffer,
 /** @export */ Ag: _emscripten_glBindSampler,
 /** @export */ zg: _emscripten_glBindTexture,
 /** @export */ yg: _emscripten_glBindTransformFeedback,
 /** @export */ xg: _emscripten_glBindVertexArray,
 /** @export */ wg: _emscripten_glBindVertexArrayOES,
 /** @export */ vg: _emscripten_glBlendColor,
 /** @export */ ug: _emscripten_glBlendEquation,
 /** @export */ tg: _emscripten_glBlendEquationSeparate,
 /** @export */ sg: _emscripten_glBlendFunc,
 /** @export */ rg: _emscripten_glBlendFuncSeparate,
 /** @export */ qg: _emscripten_glBlitFramebuffer,
 /** @export */ pg: _emscripten_glBufferData,
 /** @export */ og: _emscripten_glBufferSubData,
 /** @export */ ng: _emscripten_glCheckFramebufferStatus,
 /** @export */ mg: _emscripten_glClear,
 /** @export */ lg: _emscripten_glClearBufferfi,
 /** @export */ kg: _emscripten_glClearBufferfv,
 /** @export */ jg: _emscripten_glClearBufferiv,
 /** @export */ ig: _emscripten_glClearBufferuiv,
 /** @export */ hg: _emscripten_glClearColor,
 /** @export */ gg: _emscripten_glClearDepthf,
 /** @export */ fg: _emscripten_glClearStencil,
 /** @export */ eg: _emscripten_glClientWaitSync,
 /** @export */ dg: _emscripten_glColorMask,
 /** @export */ cg: _emscripten_glCompileShader,
 /** @export */ bg: _emscripten_glCompressedTexImage2D,
 /** @export */ ag: _emscripten_glCompressedTexImage3D,
 /** @export */ $f: _emscripten_glCompressedTexSubImage2D,
 /** @export */ _f: _emscripten_glCompressedTexSubImage3D,
 /** @export */ Zf: _emscripten_glCopyBufferSubData,
 /** @export */ Yf: _emscripten_glCopyTexImage2D,
 /** @export */ Xf: _emscripten_glCopyTexSubImage2D,
 /** @export */ Wf: _emscripten_glCopyTexSubImage3D,
 /** @export */ Vf: _emscripten_glCreateProgram,
 /** @export */ Uf: _emscripten_glCreateShader,
 /** @export */ Tf: _emscripten_glCullFace,
 /** @export */ Sf: _emscripten_glDeleteBuffers,
 /** @export */ Rf: _emscripten_glDeleteFramebuffers,
 /** @export */ Qf: _emscripten_glDeleteProgram,
 /** @export */ Pf: _emscripten_glDeleteQueries,
 /** @export */ Of: _emscripten_glDeleteQueriesEXT,
 /** @export */ Nf: _emscripten_glDeleteRenderbuffers,
 /** @export */ Mf: _emscripten_glDeleteSamplers,
 /** @export */ Lf: _emscripten_glDeleteShader,
 /** @export */ Kf: _emscripten_glDeleteSync,
 /** @export */ Jf: _emscripten_glDeleteTextures,
 /** @export */ If: _emscripten_glDeleteTransformFeedbacks,
 /** @export */ Hf: _emscripten_glDeleteVertexArrays,
 /** @export */ Gf: _emscripten_glDeleteVertexArraysOES,
 /** @export */ Ff: _emscripten_glDepthFunc,
 /** @export */ Ef: _emscripten_glDepthMask,
 /** @export */ Df: _emscripten_glDepthRangef,
 /** @export */ Cf: _emscripten_glDetachShader,
 /** @export */ Bf: _emscripten_glDisable,
 /** @export */ Af: _emscripten_glDisableVertexAttribArray,
 /** @export */ zf: _emscripten_glDrawArrays,
 /** @export */ yf: _emscripten_glDrawArraysInstanced,
 /** @export */ xf: _emscripten_glDrawArraysInstancedANGLE,
 /** @export */ wf: _emscripten_glDrawArraysInstancedARB,
 /** @export */ vf: _emscripten_glDrawArraysInstancedEXT,
 /** @export */ uf: _emscripten_glDrawArraysInstancedNV,
 /** @export */ tf: _emscripten_glDrawBuffers,
 /** @export */ sf: _emscripten_glDrawBuffersEXT,
 /** @export */ rf: _emscripten_glDrawBuffersWEBGL,
 /** @export */ qf: _emscripten_glDrawElements,
 /** @export */ pf: _emscripten_glDrawElementsInstanced,
 /** @export */ of: _emscripten_glDrawElementsInstancedANGLE,
 /** @export */ nf: _emscripten_glDrawElementsInstancedARB,
 /** @export */ mf: _emscripten_glDrawElementsInstancedEXT,
 /** @export */ lf: _emscripten_glDrawElementsInstancedNV,
 /** @export */ kf: _emscripten_glDrawRangeElements,
 /** @export */ jf: _emscripten_glEnable,
 /** @export */ hf: _emscripten_glEnableVertexAttribArray,
 /** @export */ gf: _emscripten_glEndQuery,
 /** @export */ ff: _emscripten_glEndQueryEXT,
 /** @export */ ef: _emscripten_glEndTransformFeedback,
 /** @export */ df: _emscripten_glFenceSync,
 /** @export */ cf: _emscripten_glFinish,
 /** @export */ bf: _emscripten_glFlush,
 /** @export */ af: _emscripten_glFramebufferRenderbuffer,
 /** @export */ $e: _emscripten_glFramebufferTexture2D,
 /** @export */ _e: _emscripten_glFramebufferTextureLayer,
 /** @export */ Ze: _emscripten_glFrontFace,
 /** @export */ Ye: _emscripten_glGenBuffers,
 /** @export */ Xe: _emscripten_glGenFramebuffers,
 /** @export */ We: _emscripten_glGenQueries,
 /** @export */ Ve: _emscripten_glGenQueriesEXT,
 /** @export */ Ue: _emscripten_glGenRenderbuffers,
 /** @export */ Te: _emscripten_glGenSamplers,
 /** @export */ Se: _emscripten_glGenTextures,
 /** @export */ Re: _emscripten_glGenTransformFeedbacks,
 /** @export */ Qe: _emscripten_glGenVertexArrays,
 /** @export */ Pe: _emscripten_glGenVertexArraysOES,
 /** @export */ Oe: _emscripten_glGenerateMipmap,
 /** @export */ Ne: _emscripten_glGetActiveAttrib,
 /** @export */ Me: _emscripten_glGetActiveUniform,
 /** @export */ Le: _emscripten_glGetActiveUniformBlockName,
 /** @export */ Ke: _emscripten_glGetActiveUniformBlockiv,
 /** @export */ Je: _emscripten_glGetActiveUniformsiv,
 /** @export */ Ie: _emscripten_glGetAttachedShaders,
 /** @export */ He: _emscripten_glGetAttribLocation,
 /** @export */ Ge: _emscripten_glGetBooleanv,
 /** @export */ Fe: _emscripten_glGetBufferParameteri64v,
 /** @export */ Ee: _emscripten_glGetBufferParameteriv,
 /** @export */ De: _emscripten_glGetError,
 /** @export */ Ce: _emscripten_glGetFloatv,
 /** @export */ Be: _emscripten_glGetFragDataLocation,
 /** @export */ Ae: _emscripten_glGetFramebufferAttachmentParameteriv,
 /** @export */ ze: _emscripten_glGetInteger64i_v,
 /** @export */ ye: _emscripten_glGetInteger64v,
 /** @export */ xe: _emscripten_glGetIntegeri_v,
 /** @export */ we: _emscripten_glGetIntegerv,
 /** @export */ ve: _emscripten_glGetInternalformativ,
 /** @export */ ue: _emscripten_glGetProgramBinary,
 /** @export */ te: _emscripten_glGetProgramInfoLog,
 /** @export */ se: _emscripten_glGetProgramiv,
 /** @export */ re: _emscripten_glGetQueryObjecti64vEXT,
 /** @export */ qe: _emscripten_glGetQueryObjectivEXT,
 /** @export */ pe: _emscripten_glGetQueryObjectui64vEXT,
 /** @export */ oe: _emscripten_glGetQueryObjectuiv,
 /** @export */ ne: _emscripten_glGetQueryObjectuivEXT,
 /** @export */ me: _emscripten_glGetQueryiv,
 /** @export */ le: _emscripten_glGetQueryivEXT,
 /** @export */ ke: _emscripten_glGetRenderbufferParameteriv,
 /** @export */ je: _emscripten_glGetSamplerParameterfv,
 /** @export */ ie: _emscripten_glGetSamplerParameteriv,
 /** @export */ he: _emscripten_glGetShaderInfoLog,
 /** @export */ ge: _emscripten_glGetShaderPrecisionFormat,
 /** @export */ fe: _emscripten_glGetShaderSource,
 /** @export */ ee: _emscripten_glGetShaderiv,
 /** @export */ de: _emscripten_glGetString,
 /** @export */ ce: _emscripten_glGetStringi,
 /** @export */ be: _emscripten_glGetSynciv,
 /** @export */ ae: _emscripten_glGetTexParameterfv,
 /** @export */ $d: _emscripten_glGetTexParameteriv,
 /** @export */ _d: _emscripten_glGetTransformFeedbackVarying,
 /** @export */ Zd: _emscripten_glGetUniformBlockIndex,
 /** @export */ Yd: _emscripten_glGetUniformIndices,
 /** @export */ Xd: _emscripten_glGetUniformLocation,
 /** @export */ Wd: _emscripten_glGetUniformfv,
 /** @export */ Vd: _emscripten_glGetUniformiv,
 /** @export */ Ud: _emscripten_glGetUniformuiv,
 /** @export */ Td: _emscripten_glGetVertexAttribIiv,
 /** @export */ Sd: _emscripten_glGetVertexAttribIuiv,
 /** @export */ Rd: _emscripten_glGetVertexAttribPointerv,
 /** @export */ Qd: _emscripten_glGetVertexAttribfv,
 /** @export */ Pd: _emscripten_glGetVertexAttribiv,
 /** @export */ Od: _emscripten_glHint,
 /** @export */ Nd: _emscripten_glInvalidateFramebuffer,
 /** @export */ Md: _emscripten_glInvalidateSubFramebuffer,
 /** @export */ Ld: _emscripten_glIsBuffer,
 /** @export */ Kd: _emscripten_glIsEnabled,
 /** @export */ Jd: _emscripten_glIsFramebuffer,
 /** @export */ Id: _emscripten_glIsProgram,
 /** @export */ Hd: _emscripten_glIsQuery,
 /** @export */ Gd: _emscripten_glIsQueryEXT,
 /** @export */ Fd: _emscripten_glIsRenderbuffer,
 /** @export */ Ed: _emscripten_glIsSampler,
 /** @export */ Dd: _emscripten_glIsShader,
 /** @export */ Cd: _emscripten_glIsSync,
 /** @export */ Bd: _emscripten_glIsTexture,
 /** @export */ Ad: _emscripten_glIsTransformFeedback,
 /** @export */ zd: _emscripten_glIsVertexArray,
 /** @export */ yd: _emscripten_glIsVertexArrayOES,
 /** @export */ xd: _emscripten_glLineWidth,
 /** @export */ wd: _emscripten_glLinkProgram,
 /** @export */ vd: _emscripten_glPauseTransformFeedback,
 /** @export */ ud: _emscripten_glPixelStorei,
 /** @export */ td: _emscripten_glPolygonOffset,
 /** @export */ sd: _emscripten_glProgramBinary,
 /** @export */ rd: _emscripten_glProgramParameteri,
 /** @export */ qd: _emscripten_glQueryCounterEXT,
 /** @export */ pd: _emscripten_glReadBuffer,
 /** @export */ od: _emscripten_glReadPixels,
 /** @export */ nd: _emscripten_glReleaseShaderCompiler,
 /** @export */ md: _emscripten_glRenderbufferStorage,
 /** @export */ ld: _emscripten_glRenderbufferStorageMultisample,
 /** @export */ kd: _emscripten_glResumeTransformFeedback,
 /** @export */ jd: _emscripten_glSampleCoverage,
 /** @export */ id: _emscripten_glSamplerParameterf,
 /** @export */ hd: _emscripten_glSamplerParameterfv,
 /** @export */ gd: _emscripten_glSamplerParameteri,
 /** @export */ fd: _emscripten_glSamplerParameteriv,
 /** @export */ ed: _emscripten_glScissor,
 /** @export */ dd: _emscripten_glShaderBinary,
 /** @export */ cd: _emscripten_glShaderSource,
 /** @export */ bd: _emscripten_glStencilFunc,
 /** @export */ ad: _emscripten_glStencilFuncSeparate,
 /** @export */ $c: _emscripten_glStencilMask,
 /** @export */ _c: _emscripten_glStencilMaskSeparate,
 /** @export */ Zc: _emscripten_glStencilOp,
 /** @export */ Yc: _emscripten_glStencilOpSeparate,
 /** @export */ Xc: _emscripten_glTexImage2D,
 /** @export */ Wc: _emscripten_glTexImage3D,
 /** @export */ Vc: _emscripten_glTexParameterf,
 /** @export */ Uc: _emscripten_glTexParameterfv,
 /** @export */ Tc: _emscripten_glTexParameteri,
 /** @export */ Sc: _emscripten_glTexParameteriv,
 /** @export */ Rc: _emscripten_glTexStorage2D,
 /** @export */ Qc: _emscripten_glTexStorage3D,
 /** @export */ Pc: _emscripten_glTexSubImage2D,
 /** @export */ Oc: _emscripten_glTexSubImage3D,
 /** @export */ Nc: _emscripten_glTransformFeedbackVaryings,
 /** @export */ Mc: _emscripten_glUniform1f,
 /** @export */ Lc: _emscripten_glUniform1fv,
 /** @export */ Kc: _emscripten_glUniform1i,
 /** @export */ Jc: _emscripten_glUniform1iv,
 /** @export */ Ic: _emscripten_glUniform1ui,
 /** @export */ Hc: _emscripten_glUniform1uiv,
 /** @export */ Gc: _emscripten_glUniform2f,
 /** @export */ Fc: _emscripten_glUniform2fv,
 /** @export */ Ec: _emscripten_glUniform2i,
 /** @export */ Dc: _emscripten_glUniform2iv,
 /** @export */ Cc: _emscripten_glUniform2ui,
 /** @export */ Bc: _emscripten_glUniform2uiv,
 /** @export */ Ac: _emscripten_glUniform3f,
 /** @export */ zc: _emscripten_glUniform3fv,
 /** @export */ yc: _emscripten_glUniform3i,
 /** @export */ xc: _emscripten_glUniform3iv,
 /** @export */ wc: _emscripten_glUniform3ui,
 /** @export */ vc: _emscripten_glUniform3uiv,
 /** @export */ uc: _emscripten_glUniform4f,
 /** @export */ tc: _emscripten_glUniform4fv,
 /** @export */ sc: _emscripten_glUniform4i,
 /** @export */ rc: _emscripten_glUniform4iv,
 /** @export */ qc: _emscripten_glUniform4ui,
 /** @export */ pc: _emscripten_glUniform4uiv,
 /** @export */ oc: _emscripten_glUniformBlockBinding,
 /** @export */ nc: _emscripten_glUniformMatrix2fv,
 /** @export */ mc: _emscripten_glUniformMatrix2x3fv,
 /** @export */ lc: _emscripten_glUniformMatrix2x4fv,
 /** @export */ kc: _emscripten_glUniformMatrix3fv,
 /** @export */ jc: _emscripten_glUniformMatrix3x2fv,
 /** @export */ ic: _emscripten_glUniformMatrix3x4fv,
 /** @export */ hc: _emscripten_glUniformMatrix4fv,
 /** @export */ gc: _emscripten_glUniformMatrix4x2fv,
 /** @export */ fc: _emscripten_glUniformMatrix4x3fv,
 /** @export */ ec: _emscripten_glUseProgram,
 /** @export */ dc: _emscripten_glValidateProgram,
 /** @export */ cc: _emscripten_glVertexAttrib1f,
 /** @export */ bc: _emscripten_glVertexAttrib1fv,
 /** @export */ ac: _emscripten_glVertexAttrib2f,
 /** @export */ $b: _emscripten_glVertexAttrib2fv,
 /** @export */ _b: _emscripten_glVertexAttrib3f,
 /** @export */ Zb: _emscripten_glVertexAttrib3fv,
 /** @export */ Yb: _emscripten_glVertexAttrib4f,
 /** @export */ Xb: _emscripten_glVertexAttrib4fv,
 /** @export */ Wb: _emscripten_glVertexAttribDivisor,
 /** @export */ Vb: _emscripten_glVertexAttribDivisorANGLE,
 /** @export */ Ub: _emscripten_glVertexAttribDivisorARB,
 /** @export */ Tb: _emscripten_glVertexAttribDivisorEXT,
 /** @export */ Sb: _emscripten_glVertexAttribDivisorNV,
 /** @export */ Rb: _emscripten_glVertexAttribI4i,
 /** @export */ Qb: _emscripten_glVertexAttribI4iv,
 /** @export */ Pb: _emscripten_glVertexAttribI4ui,
 /** @export */ Ob: _emscripten_glVertexAttribI4uiv,
 /** @export */ Nb: _emscripten_glVertexAttribIPointer,
 /** @export */ Mb: _emscripten_glVertexAttribPointer,
 /** @export */ Lb: _emscripten_glViewport,
 /** @export */ Kb: _emscripten_glWaitSync,
 /** @export */ Jb: _emscripten_html5_remove_all_event_listeners,
 /** @export */ Ib: _emscripten_memcpy_js,
 /** @export */ Hb: _emscripten_request_pointerlock,
 /** @export */ Gb: _emscripten_resize_heap,
 /** @export */ ua: _emscripten_sample_gamepad_data,
 /** @export */ X: _emscripten_set_canvas_element_size,
 /** @export */ Fb: _emscripten_set_element_css_size,
 ...
 /** @export */ zb: _emscripten_set_main_loop,
 /** @export */ yb: _emscripten_set_main_loop_arg,
 /** @export */ P: _emscripten_set_main_loop_timing,
 /** @export */ xb: _emscripten_set_mousedown_callback_on_thread,
 /** @export */ wb: _emscripten_set_mousemove_callback_on_thread,
 /** @export */ vb: _emscripten_set_mouseup_callback_on_thread,
 /** @export */ ub: _emscripten_set_pointerlockchange_callback_on_thread,
 /** @export */ tb: _emscripten_set_touchcancel_callback_on_thread,
 /** @export */ sb: _emscripten_set_touchend_callback_on_thread,
 /** @export */ rb: _emscripten_set_touchmove_callback_on_thread,
 /** @export */ qb: _emscripten_set_touchstart_callback_on_thread,
 /** @export */ pb: _emscripten_set_wheel_callback_on_thread,
 /** @export */ O: _emscripten_sleep,
 /** @export */ ob: _emscripten_webgl_create_context,
 /** @export */ ta: _emscripten_webgl_destroy_context,
 /** @export */ nb: _emscripten_webgl_get_drawing_buffer_size,
 /** @export */ mb: _emscripten_webgl_init_context_attributes,
 /** @export */ sa: _emscripten_webgl_make_context_current,
 /** @export */ th: _environ_get,
 /** @export */ sh: _environ_sizes_get,
 /** @export */ ra: _exit,
 /** @export */ K: _fd_close,
 /** @export */ Fa: _fd_read,
 /** @export */ Ma: _fd_seek,
 /** @export */ _: _fd_write,
 /** @export */ lb: _getaddrinfo,
 /** @export */ kb: _getnameinfo,
 /** @export */ G: _glActiveTexture,
 /** @export */ qa: _glAttachShader,
 /** @export */ pa: _glBindBuffer,
 /** @export */ n: _glBindFramebuffer,
 /** @export */ N: _glBindRenderbuffer,
 /** @export */ b: _glBindTexture,
 /** @export */ J: _glBlendEquation,
 /** @export */ x: _glBlendFunc,
 /** @export */ jb: _glBufferData,
 /** @export */ F: _glCheckFramebufferStatus,
 /** @export */ C: _glClear,
 /** @export */ W: _glClearColor,
 /** @export */ ib: _glCompileShader,
 /** @export */ hb: _glCreateProgram,
 /** @export */ oa: _glCreateShader,
 /** @export */ V: _glDeleteBuffers,
 /** @export */ w: _glDeleteFramebuffers,
 /** @export */ na: _glDeleteProgram,
 /** @export */ ma: _glDeleteRenderbuffers,
 /** @export */ la: _glDeleteShader,
 /** @export */ i: _glDeleteTextures,
 /** @export */ h: _glDisable,
 /** @export */ U: _glDisableVertexAttribArray,
 /** @export */ p: _glDrawArrays,
 /** @export */ B: _glEnable,
 /** @export */ gb: _glEnableVertexAttribArray,
 /** @export */ fb: _glFinish,
 /** @export */ eb: _glFlush,
 /** @export */ T: _glFramebufferRenderbuffer,
 /** @export */ E: _glFramebufferTexture2D,
 /** @export */ ka: _glGenBuffers,
 /** @export */ S: _glGenFramebuffers,
 /** @export */ db: _glGenRenderbuffers,
 /** @export */ u: _glGenTextures,
 /** @export */ M: _glGenerateMipmap,
 /** @export */ ja: _glGetAttribLocation,
 /** @export */ ia: _glGetError,
 /** @export */ R: _glGetIntegerv,
 /** @export */ cb: _glGetProgramInfoLog,
 /** @export */ ha: _glGetProgramiv,
 /** @export */ bb: _glGetShaderInfoLog,
 /** @export */ ga: _glGetShaderiv,
 /** @export */ d: _glGetString,
 /** @export */ A: _glGetUniformLocation,
 /** @export */ fa: _glIsProgram,
 /** @export */ ab: _glLinkProgram,
 /** @export */ v: _glPixelStorei,
 /** @export */ ea: _glReadPixels,
 /** @export */ da: _glRenderbufferStorage,
 /** @export */ ca: _glScissor,
 /** @export */ $a: _glShaderSource,
 /** @export */ t: _glTexImage2D,
 /** @export */ c: _glTexParameteri,
 /** @export */ L: _glTexSubImage2D,
 /** @export */ I: _glUniform1f,
 /** @export */ _a: _glUniform1fv,
 /** @export */ m: _glUniform1i,
 /** @export */ Za: _glUniform2f,
 /** @export */ j: _glUniform2fv,
 /** @export */ Ya: _glUniform3f,
 /** @export */ Xa: _glUniform3fv,
 /** @export */ Wa: _glUniform4f,
 /** @export */ Va: _glUniform4fv,
 /** @export */ Ua: _glUniformMatrix4fv,
 /** @export */ z: _glUseProgram,
 /** @export */ Ta: _glVertexAttribPointer,
 /** @export */ s: _glViewport,
 /** @export */ ba: invoke_i,
 /** @export */ g: invoke_ii,
 /** @export */ r: invoke_iii,
 /** @export */ q: invoke_iiii,
 /** @export */ Sa: invoke_iiiii,
 /** @export */ aa: invoke_iiiiii,
 /** @export */ Ra: invoke_iiiiiii,
 /** @export */ Ja: invoke_j,
 /** @export */ l: invoke_v,
 /** @export */ e: invoke_vi,
 /** @export */ a: invoke_vii,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["Yh"])();

var _free = Module["_free"] = a0 => (_free = Module["_free"] = wasmExports["_h"])(a0);

var _malloc = Module["_malloc"] = a0 => (_malloc = Module["_malloc"] = wasmExports["$h"])(a0);

var setTempRet0 = a0 => (setTempRet0 = wasmExports["ai"])(a0);

var ___errno_location = () => (___errno_location = wasmExports["bi"])();

var _PlatformEmscriptenCommandRaiseFlag = () => (_PlatformEmscriptenCommandRaiseFlag = wasmExports["ci"])();

var _cmd_savefiles = Module["_cmd_savefiles"] = () => (_cmd_savefiles = Module["_cmd_savefiles"] = wasmExports["di"])();

var _cmd_save_state = Module["_cmd_save_state"] = () => (_cmd_save_state = Module["_cmd_save_state"] = wasmExports["ei"])();

var _cmd_load_state = Module["_cmd_load_state"] = () => (_cmd_load_state = Module["_cmd_load_state"] = wasmExports["fi"])();

var _cmd_undo_save_state = Module["_cmd_undo_save_state"] = () => (_cmd_undo_save_state = Module["_cmd_undo_save_state"] = wasmExports["gi"])();

var _cmd_undo_load_state = Module["_cmd_undo_load_state"] = () => (_cmd_undo_load_state = Module["_cmd_undo_load_state"] = wasmExports["hi"])();

var _cmd_take_screenshot = Module["_cmd_take_screenshot"] = () => (_cmd_take_screenshot = Module["_cmd_take_screenshot"] = wasmExports["ii"])();

var _cmd_toggle_menu = Module["_cmd_toggle_menu"] = () => (_cmd_toggle_menu = Module["_cmd_toggle_menu"] = wasmExports["ji"])();

var _cmd_reload_config = Module["_cmd_reload_config"] = () => (_cmd_reload_config = Module["_cmd_reload_config"] = wasmExports["ki"])();

var _cmd_toggle_grab_mouse = Module["_cmd_toggle_grab_mouse"] = () => (_cmd_toggle_grab_mouse = Module["_cmd_toggle_grab_mouse"] = wasmExports["li"])();

var _cmd_toggle_game_focus = Module["_cmd_toggle_game_focus"] = () => (_cmd_toggle_game_focus = Module["_cmd_toggle_game_focus"] = wasmExports["mi"])();

var _cmd_reset = Module["_cmd_reset"] = () => (_cmd_reset = Module["_cmd_reset"] = wasmExports["ni"])();

var _cmd_toggle_pause = Module["_cmd_toggle_pause"] = () => (_cmd_toggle_pause = Module["_cmd_toggle_pause"] = wasmExports["oi"])();

var _cmd_pause = Module["_cmd_pause"] = () => (_cmd_pause = Module["_cmd_pause"] = wasmExports["pi"])();

var _cmd_unpause = Module["_cmd_unpause"] = () => (_cmd_unpause = Module["_cmd_unpause"] = wasmExports["qi"])();

var _cmd_set_volume = Module["_cmd_set_volume"] = a0 => (_cmd_set_volume = Module["_cmd_set_volume"] = wasmExports["ri"])(a0);

var _cmd_set_shader = Module["_cmd_set_shader"] = a0 => (_cmd_set_shader = Module["_cmd_set_shader"] = wasmExports["si"])(a0);

var _cmd_cheat_set_code = Module["_cmd_cheat_set_code"] = (a0, a1) => (_cmd_cheat_set_code = Module["_cmd_cheat_set_code"] = wasmExports["ti"])(a0, a1);

var _cmd_cheat_get_code = Module["_cmd_cheat_get_code"] = a0 => (_cmd_cheat_get_code = Module["_cmd_cheat_get_code"] = wasmExports["ui"])(a0);

var _cmd_cheat_toggle_index = Module["_cmd_cheat_toggle_index"] = (a0, a1) => (_cmd_cheat_toggle_index = Module["_cmd_cheat_toggle_index"] = wasmExports["vi"])(a0, a1);

var _cmd_cheat_get_code_state = Module["_cmd_cheat_get_code_state"] = a0 => (_cmd_cheat_get_code_state = Module["_cmd_cheat_get_code_state"] = wasmExports["wi"])(a0);

var _cmd_cheat_realloc = Module["_cmd_cheat_realloc"] = a0 => (_cmd_cheat_realloc = Module["_cmd_cheat_realloc"] = wasmExports["xi"])(a0);

var _cmd_cheat_get_size = Module["_cmd_cheat_get_size"] = () => (_cmd_cheat_get_size = Module["_cmd_cheat_get_size"] = wasmExports["yi"])();

var _cmd_cheat_apply_cheats = Module["_cmd_cheat_apply_cheats"] = () => (_cmd_cheat_apply_cheats = Module["_cmd_cheat_apply_cheats"] = wasmExports["zi"])();

var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["Ai"])(a0, a1);

var _htons = a0 => (_htons = wasmExports["Bi"])(a0);

var _ntohs = a0 => (_ntohs = wasmExports["Ci"])(a0);

var _htonl = a0 => (_htonl = wasmExports["Di"])(a0);

var _setThrew = (a0, a1) => (_setThrew = wasmExports["Ei"])(a0, a1);

var stackSave = () => (stackSave = wasmExports["Fi"])();

var stackRestore = a0 => (stackRestore = wasmExports["Gi"])(a0);

var stackAlloc = a0 => (stackAlloc = wasmExports["Hi"])(a0);

var dynCall_v = Module["dynCall_v"] = a0 => (dynCall_v = Module["dynCall_v"] = wasmExports["Ii"])(a0);

var dynCall_viiii = Module["dynCall_viiii"] = (a0, a1, a2, a3, a4) => (dynCall_viiii = Module["dynCall_viiii"] = wasmExports["Ji"])(a0, a1, a2, a3, a4);

var dynCall_i = Module["dynCall_i"] = a0 => (dynCall_i = Module["dynCall_i"] = wasmExports["Ki"])(a0);

var dynCall_ii = Module["dynCall_ii"] = (a0, a1) => (dynCall_ii = Module["dynCall_ii"] = wasmExports["Li"])(a0, a1);

var dynCall_vii = Module["dynCall_vii"] = (a0, a1, a2) => (dynCall_vii = Module["dynCall_vii"] = wasmExports["Mi"])(a0, a1, a2);

var dynCall_iiii = Module["dynCall_iiii"] = (a0, a1, a2, a3) => (dynCall_iiii = Module["dynCall_iiii"] = wasmExports["Ni"])(a0, a1, a2, a3);

var dynCall_iiiiii = Module["dynCall_iiiiii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiii = Module["dynCall_iiiiii"] = wasmExports["Oi"])(a0, a1, a2, a3, a4, a5);

var dynCall_vi = Module["dynCall_vi"] = (a0, a1) => (dynCall_vi = Module["dynCall_vi"] = wasmExports["Pi"])(a0, a1);

var dynCall_viii = Module["dynCall_viii"] = (a0, a1, a2, a3) => (dynCall_viii = Module["dynCall_viii"] = wasmExports["Qi"])(a0, a1, a2, a3);

var dynCall_iiiii = Module["dynCall_iiiii"] = (a0, a1, a2, a3, a4) => (dynCall_iiiii = Module["dynCall_iiiii"] = wasmExports["Ri"])(a0, a1, a2, a3, a4);

var dynCall_iii = Module["dynCall_iii"] = (a0, a1, a2) => (dynCall_iii = Module["dynCall_iii"] = wasmExports["Si"])(a0, a1, a2);

var dynCall_iiiiiii = Module["dynCall_iiiiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiiii = Module["dynCall_iiiiiii"] = wasmExports["Ti"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_j = Module["dynCall_j"] = a0 => (dynCall_j = Module["dynCall_j"] = wasmExports["Ui"])(a0);

var _asyncify_start_unwind = a0 => (_asyncify_start_unwind = wasmExports["Vi"])(a0);

var _asyncify_stop_unwind = () => (_asyncify_stop_unwind = wasmExports["Wi"])();

var _asyncify_start_rewind = a0 => (_asyncify_start_rewind = wasmExports["Xi"])(a0);

var _asyncify_stop_rewind = () => (_asyncify_stop_rewind = wasmExports["Yi"])();
...
export default libretro_pcsx_rearmed;