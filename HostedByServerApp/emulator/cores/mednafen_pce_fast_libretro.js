...
var libretro_mednafen_pce_fast = (() => {
...
if (Module["locateFile"]) {
 wasmBinaryFile = "mednafen_pce_fast_libretro.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("mednafen_pce_fast_libretro.wasm", import.meta.url).href;
}
...
var wasmImports = {
 ...
 /** @export */ ra: _glAttachShader,
 /** @export */ qa: _glBindBuffer,
 /** @export */ o: _glBindFramebuffer,
...
export default libretro_mednafen_pce_fast;