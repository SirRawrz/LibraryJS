class EJS_GameManager {
  ...
  writeConfigFile() {
           this.EJS.defaultCoreOpts.settings = {
            ...this.EJS.defaultCoreOpts.settings,
            'pcsx_rearmed_psxclock': '30',
    ...
    writeConfigFile() {
     this.EJS.defaultCoreOpts.settings = {
        ...this.EJS.defaultCoreOpts.settings, // Preserve existing settings
        'pcsx_rearmed_psxclock': '30',        // Force PSX clock to 30
        'pcsx_rearmed_cd_readahead': '32'       // Force CD readahead to 32
    };
